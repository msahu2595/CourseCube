...
import {VideoItem, Fab} from '@components';
...
const AdminCourseVideoListScreen = ({route: {params}}) => {
  ...
  const _renderItem = useCallback(
    ({item}) => (
      <View>
        <VideoItem {...item} width={itemWidth} />
...
export default AdminCourseVideoListScreen;
